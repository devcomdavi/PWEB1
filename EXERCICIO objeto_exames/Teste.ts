import { Answer, Weight, Exam } from './Exam';

// Criar o gabarito
const gabarito = new Answer("Gabarito Oficial", ["A", "B", "C", "D", "E"]);
...
const aluno1 = new Answer("João", ["A", "B", "C", "A", "E"]); // Errou a 4 (nota 8)
const aluno2 = new Answer("Maria", ["A", "B", "B", "D", "E"]); // Errou a 3 (nota 8)
const aluno3 = new Answer("Pedro", ["B", "A", "D", "E", "C"]); // Errou todas (nota 0)
const aluno4 = new Answer("Ana", ["A", "B", "C", "D", "E"]); // Acertou todas (nota 10)
